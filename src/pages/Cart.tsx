...
import emptyCart from '../assets/img/empty-cart (1).png'
        ...
        <div className="container container--cart">
          {
            ...
            <p>
              Вероятней всего, вы не заказывали ещё продукты.<br />
              Для того, чтобы заказать продукты , перейдите на главную страницу.
            </p>
